...
Monster* Map::checkRandomEncounter()
{
	...
	else if(roll >= 6 && roll <= 10)
	{
		...
		monster = new Monster("Orc", 10, 8, 200, Random(1, 50), 1, "Short Sword", 2, 7);
	...
	{
		// initialise a monster object
		monster = new Monster("Goblin", 6, 6, 100, Random(1, 100), 0, "Dagger", 1, 5);
		// and output a message to the player
	...
	{
		// initialise a monster object
		monster = new Monster("Ogre", 20, 12, 500, Random(1, 250), 2, "Club", 3, 8);
		// and output a message to the player
	...
	{
		// initialise a monster object
		monster = new Monster("Orc Lord", 25, 15, 2000, Random(1, 1000), 5, "Two Handed Sword", 5, 20);
		// and output a message to the player
